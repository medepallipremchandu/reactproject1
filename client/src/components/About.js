...
function About() {
    return(
        ...
        <br/>
        <p className="p">Computer Science Engineering in B.Tech. Ability to work with C, C++, Python, java script. A work well under pressure and make the best of any situation. Passionate individual with great interpersonal and communication skills.</p>
